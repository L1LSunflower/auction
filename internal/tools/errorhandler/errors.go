...
var (
	...
	ErrActiveAuctionNotExist = errors.New("that auction not active")
	...
	ErrSetVisit              = errors.New("failed to set visit dates")
	ErrVisit                 = errors.New("failed visit auction")
	ErrUnvisit               = errors.New("failed to unset visit")
	ErrNotAuctionOwner       = errors.New("error not auction owner")
	ErrAuctionVisitors       = errors.New("failed to get auction visitors")
	ErrAuctionVisitor        = errors.New("failed to get auction visitor")
	ErrUpdateAuction         = errors.New("failed to update auction")
	ErrAlreadyVisitor        = errors.New("that user already visitor")
	ErrUpdateVisit           = errors.New("failed to update visit auction")
	// Error for Balances
